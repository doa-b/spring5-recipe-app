...
public class RecipeBootstrap implements CommandLineRunner {
    ...
    private void LoadData() {
        ...
        UnitOfMeasure eachOne = unitOfMeasureRepository.findByDescription("Each").get();
...
//        perfectGuacamole.getIngredients().add(new Ingredient("ripe tomato, seeds and pulp removed, chopped", new BigDecimal(".5"), eachOne, perfectGuacamole));
        ...
        tacosRecipe.getIngredients().add(new Ingredient("Clove of Garlic, Choppedr", new BigDecimal(1), eachOne, tacosRecipe));
        ...
        tacosRecipe.getIngredients().add(new Ingredient("red onion, thinly sliced", new BigDecimal(".25"), eachOne, tacosRecipe));
        tacosRecipe.getIngredients().add(new Ingredient("Roughly chopped cilantro", new BigDecimal(4), eachOne, tacosRecipe));
